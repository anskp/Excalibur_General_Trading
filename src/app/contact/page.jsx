          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal className="text-center mb-16">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-charcoal">
                Connect with
                <span className="text-gradient-gold"> Excalibur Trading</span>
              </h1>
            ...
            <ScrollReveal delay={0.08}>
              <div className="glass-card rounded-3xl p-8 lg:p-12 border border-gold/15 shadow-xl shadow-gold/5">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <a href="tel:+971585930053" className="text-sm text-charcoal/50 hover:text-crimson transition-colors">
                            +971585930053
                          </a>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                      ...
                      <div>
                        ...
                        <textarea rows={4} placeholder="Tell us your product requirements..." className="w-full px-4 py-3 rounded-xl bg-ivory/80 border border-border text-sm text-charcoal placeholder:text-charcoal/30 focus:outline-none focus:border-gold/40 focus:ring-2 focus:ring-gold/10 transition-all resize-none" />
                      </div>
