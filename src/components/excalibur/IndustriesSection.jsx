...
export function IndustriesSection() {
    return (<section id="industries" className="relative py-24 lg:py-32">
        ...
        <StaggerContainer staggerDelay={0.06} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-5">
          {industries.map((industry) => {
            ...
            return (<StaggerItem key={industry.title}>
                <div className={`group relative h-full rounded-3xl glass-card hover:glass-card-hover border ${styles.border} p-6 transition-all duration-500 hover:-translate-y-1 hover:shadow-lg card-shine cursor-pointer overflow-hidden`}>
                  {/* Top accent bar */}
