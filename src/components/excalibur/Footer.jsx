...
export function Footer() {
  ...
  return (
    <footer className="relative bg-[#08122E] text-white">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-white/70">Musaffah, M14, Abu Dhabi, UAE</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-gold/60 flex-shrink-0" />
                <span className="text-sm text-white/70">sales@excaliburuae.com</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-gold/60 flex-shrink-0" />
                <span className="text-sm text-white/70">+971585930053</span>
              </div>
              <div className="flex items-center gap-3">
                <Globe className="w-4 h-4 text-gold/60 flex-shrink-0" />
                <span className="text-sm text-white/70">www.excaliburuae.com</span>
              </div>
            </div>
          </div>
              ...
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-white/70 hover:text-gold-light transition-colors duration-300"
                    >
                      {link.label}
                    </Link>
                  </li>
      ...
      <div className="border-t border-white/8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="#" className="text-xs text-white/45 hover:text-gold-light transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-xs text-white/45 hover:text-gold-light transition-colors">
              Terms of Service
            ...
            <button
              onClick={scrollToTop}
              className="w-8 h-8 rounded-full bg-white/8 hover:bg-gold/20 flex items-center justify-center transition-colors"
