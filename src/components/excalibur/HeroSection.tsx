        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border border-gold/20 mb-8"
            >
            ...
            <motion.p
              ...
              className="mt-6 text-base sm:text-lg text-charcoal/60 leading-relaxed max-w-xl"
            >
            ...
            >
              <Link
                href="#solutions"
                className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-crimson text-white font-semibold rounded-full shadow-xl shadow-crimson/20 hover:shadow-crimson/30 hover:-translate-y-0.5 transition-all duration-300"
              >
                Explore Solutions
              ...
              <Link
                href="#global"
                className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 glass-card text-charcoal font-semibold rounded-full hover:bg-ivory transition-all duration-300"
              >
                Global Presence
