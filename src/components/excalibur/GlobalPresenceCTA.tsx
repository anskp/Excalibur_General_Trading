        ...
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          <ScrollReveal direction="left" className="lg:col-span-3">
            <div className="relative rounded-3xl overflow-hidden group">
              <div
                ...
                style={{ backgroundImage: "url('/images/global-map.png')" }}
              />
              {/* Overlay */}
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            {[
              ...
              <ScrollReveal key={item.region} delay={index * 0.08} direction="right">
                ...
                <div>
                  <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl bg-ivory/80 border border-border text-sm text-charcoal placeholder:text-charcoal/30 focus:outline-none focus:border-gold/40 focus:ring-2 focus:ring-gold/10 transition-all"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-2 block">
                    ...
                    <div>
                      ...
                      <select
                        className="w-full px-4 py-3 rounded-xl bg-ivory/80 border border-border text-sm text-charcoal/70 focus:outline-none focus:border-gold/40 focus:ring-2 focus:ring-gold/10 transition-all appearance-none"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-ivory/80 border border-border text-sm text-charcoal placeholder:text-charcoal/30 focus:outline-none focus:border-gold/40 focus:ring-2 focus:ring-gold/10 transition-all resize-none"
                      />
                    </div>
                    <button
                      type="submit"
                      className="group w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-crimson text-white font-semibold rounded-xl shadow-lg shadow-crimson/20 hover:shadow-crimson/30 hover:bg-crimson-dark transition-all duration-300 hover:-translate-y-0.5"
                    >
                      Send Inquiry
